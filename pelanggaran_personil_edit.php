<?PHP
    ...
    try {
        ...
        $query = "
                select 
                    ...
                    gpl.no_ktp
                from 
                    pelanggaran_personil_tab as pp
                left join 
                    gen_pelanggar_tab as gpl on gpl.id_pelanggar = pp.id_pelanggar
                where id = '$id'";
        
        $result = $db->prepare($query);
        $result->execute();
        
        $numPlg = $result->rowCount();
    ...
    try {
        ...
        if($num > 0) {
            while ($row = $result->fetch(PDO::FETCH_NUM)) {
                if($row[0]==$pelanggar){
                    $strPelanggar = $strPelanggar."<option value='$row[0]' selected>$row[1]</option>";
                }else{
                    $strPelanggar = $strPelanggar."<option value='$row[0]'>$row[1]</option>";
                }
            }
        }
        ...
        try {
            ...
            if($waktu=="" || $id_pelanggar=="" || $no_ktp=="" || $pekerjaan=="" || $perusahaan=="" || $lokasi=="" || $pelanggaran==""){
                ...
                if($sqlQuery->rowCount() > 0){
                    ...
                    // header('location:pelanggaran_personil_edit.php?id='.base64_encode($id));
                    // echo '<script>alert("Data berhasil diupdate!")</script>'; 
                    header("Refresh:0");
                    $strMessage = "<div class='alert alert-success'><strong>Data berhasil diupdate</strong></div>";
                }else{
                ...
                <div class="box-typical box-typical-padding">
                    ...
                    <form id="form_pelanggaran_personil" class="sign-box" action="" method="post" enctype="multipart/form-data">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <div class='input-group date'>
                                    <input id="daterange3" type="text" name="tanggal" value="<?php echo $tanggal; ?>" class="form-control">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <input type="text" class="form-control clockpicker" value="<?php date_default_timezone_set('Asia/Jakarta'); echo $waktu; ?>" id="waktu" name="waktu">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <p class="form-control-static"><input type="text" class="form-control" id="no_ktp_front" name="no_ktp_front" placeholder="Masukkan nomor KTP pelanggar" value="<?php echo $no_ktp; ?>"></p>
                            </div>
                        </div><div class="form-group row">
                            <label class="col-sm-2 form-control-label">Pekerjaan<span class="required">*</span></label>
                            <div class="col-sm-10">
                                <p class="form-control-static"><input type="text" class="form-control" name="pekerjaan" id="pekerjaan" value="<?php echo $pekerjaan; ?>" placeholder="Masukkan pekerjaan pelanggar"></p>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                                <div class="pull-right">
                                    ...
                                    <button type="submit" class="btn" name="btnSimpan" id="btnSimpan">Update</button>
                                </div>
                            </div>
                        </div>
                    </form>
