                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <fieldset class="form-group">
                                        <label class="form-label " for="email_penanggungjawab">Email Penanggung Jawab</label>
                                        <input type="text" class="form-control" name="email_penanggungjawab" id="email_penanggungjawab" placeholder="Masukkan email penanggung jawab...">
                                    </fieldset>
                                </div>
                            </div><!--.row-->
                        </div>
                ...
                $(document).on('click', '.edit', function(event){
                    ...
                    $.ajax({
                        ...
                        success:function(data){
                            ...
                            $('#email_penanggungjawab').val(data.email_penanggungjawab)
