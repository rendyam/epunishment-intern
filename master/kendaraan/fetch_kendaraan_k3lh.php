<?php
    ...
    $conn = mysqli_connect($hostVPACS, $dbuserVPACS, $dbpassVPACS, $dbnameVPACS);
    $connPocis = mysqli_connect($hostPocis, $dbuserPocis, $dbpassPocis, $dbnamePocis);
