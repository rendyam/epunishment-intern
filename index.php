            ...
            if($rowCount > 0){
                foreach($result as $row){
                    ...
                    if(password_verify($password, $passDB)){
                        $_SESSION['sessidetilang'] = $row[0];
                        $_SESSION['sessunameetilang'] = $row[2];
                        $_SESSION['sessnameetilang'] = $row[1];
...
<head lang="en">
	...
	<title>e-Punishment PT. KBS</title>
        ...
        <div class="page-center-in">
            <div class="container-fluid">
                <form id="frmLogin" class="sign-box" action="" method="post" enctype="multipart/form-data">
                    ...
                    <header class="sign-title">e-Punishment PT. KBS</header>
                    <?PHP echo $strMessage;?>
