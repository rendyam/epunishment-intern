<?PHP
    ...
    try {
        ...
        $query = "SELECT a.jumlah_sp_aktif, a.masa_berlaku from pelanggaran_rpt a WHERE a.no_polisi = '$txtNopol'";
	...
	<div class="page-content">
            ...
            <div class="container-fluid">
                <div class="box-typical box-typical-padding">
                    <h2 class="with-border">Edit Pelanggaran Kendaraan Angkutan Barang</h2>
