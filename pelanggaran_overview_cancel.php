...
try {
    ...
    if ($num > 0) {
        while ($row = $result->fetch(PDO::FETCH_NUM)) {
            ...
            $str = $str . "<td valign='top'>" . $row[24] . "</td>"; //pic tilang
            $str = $str . "<td valign='top'>" . $row[25] . "</td>"; //pic tilang

            $row[0] = base64_encode($row[0]);

            // if($row[1]==1){
            $str = $str . "<td class='center' width='150px'>
                                    <a class='btn btn-success' href='pelanggaran_restore.php?id=$row[0]'>
            ...
            <header class="box-typical box-typical-padding">
                <header class="section-header">
                    <div class="tbl">
                        <div class="tbl-row">
                            <div class="tbl-cell">
                                <h2 class="with-border">Daftar Pelanggaran Di-cancel</h2>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <ul class="nav nav-pills">
                                    <li class="nav-item">
                                        <a class="nav-link" href="pelanggaran_overview.php">Semua Daftar</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link active" href='pelanggaran_overview_cancel.php'>Di-cancel (<?php echo $numCancel; ?>) </a>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-md-6">
