                    ...
                    <form id="frmLogin" class="sign-box" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div id="detail">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="pekerjaan" id="pekerjaan" placeholder="Masukkan pekerjaan pelanggar">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea rows="4" class="form-control" id="keterangan" name="keterangan" placeholder="Tuliskan keterangan tambahan mengenai pelanggaran yang terjadi"></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-6 form-control-label">
                                    <p>Dengan menyimpan input pelanggaran ini, maka statusnya 'Draft'</p>
                                </label>
                            </div>
                            <div class="tbl">
                                <div class="tbl-row">
            ...
            $(document).ready(function(){
                ...
                $('#klasifikasi_select').change(function(){
                    ...
                    if(id_klasifikasi == 3){ 
                        ...
                        if(id_klasifikasi == 1){
                            $(".selectjs").select2({
                                placeholder: "Ketik nomor polisi kendaraan angkutan barang...",
                            ...
                            $(".selectjs").select2({
                                placeholder: "Ketik nomor polisi kendaraan non-angkutan barang...",
                                minimumInputLength: 2,
                                ajax: {
                ...
                $('#frmLogin').validate({
					...
					submitHandler: function (form) {
                        if(confirm("Data akan disimpan, apakah Anda sudah yakin dengan data yang diinput?")){
                            form.submit();
                        } else {
                            return false
                        }
